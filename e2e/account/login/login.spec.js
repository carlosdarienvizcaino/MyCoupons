...
describe('Login View', function() {
  ...
  it('should include About form with correct inputs and submit button', function() {
  ...
  describe('with local auth', function() {
    ...
    it('should indicate About failures', function() {
      page.login({
        email: testUser.email,
        password: 'badPassword'
      });

      expect(browser.getCurrentUrl()).toBe(config.baseUrl + '/About');
