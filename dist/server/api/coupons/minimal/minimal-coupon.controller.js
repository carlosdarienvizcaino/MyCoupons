...
module.exports = function (req, res) {
  ...
  minimalCouponService.getMinimalCoupon(accessToken, id, userId).then(function (minimalCoupon) {
    res.status(200).send(minimalCoupon);
  }).catch(function (failedMinimalCoupon) {
    res.status(400).send(failedMinimalCoupon);
  });
};
//# sourceMappingURL=minimal-coupon.controller.js.map
