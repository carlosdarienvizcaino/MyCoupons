...
var _user = require('../api/user_example/user.model');
...
/**
 * Attaches the user_example object to the request if authenticated
...
function isAuthenticated() {
  ...
  // Attach user_example to request
  .use(function (req, res, next) {
...
/**
 * Checks if the user_example role meets the minimum requirements of the route
 */
