...
module.exports = function(req, res){
    ...
    companyAllCouponsService.getIdsForAllPromotionalEmailBeforeNDay(accessToken, userId, day)
      .then( email => {

        companyAllCouponsService.getCouponsPerCompany(accessToken, email.messages, userId)
          .then( companiesList => {
